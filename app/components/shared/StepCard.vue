  ...
  <div
    ...
    :class="[
      locked
        ...
        : 'bg-white border-gray-100 shadow-sm hover:shadow-xl hover:shadow-indigo-500/5'
    ]"
  >
    <!-- Background Decoration for active state -->
    <div 
      v-if="!locked" 
      class="absolute -top-12 -right-12 h-32 w-32 rounded-full bg-indigo-50/50 blur-2xl transition-opacity duration-500 group-hover:opacity-100"
    ></div>
      ...
      <div class="flex flex-col sm:flex-row sm:items-start gap-6">
        ...
        <div class="flex-1">
          <div class="flex items-start justify-between">
            ...
            <div v-if="locked" class="text-gray-300 bg-gray-100 p-2 rounded-xl">
              <svg
          ...
          <div
            v-else
            class="mt-6 flex flex-col items-center justify-center rounded-2xl border-2 border-dashed border-gray-100 py-10 text-center bg-gray-50/30"
          >
            <div class="bg-white p-3 rounded-full shadow-sm mb-3">
               <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" class="text-gray-300">
                <rect width="18" height="11" x="3" y="11" rx="2" ry="2" />
                <path d="M7 11V7a5 5 0 0 1 10 0v4" />
              </svg>
            </div>
