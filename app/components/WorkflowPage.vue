    ...
    >
      <div class="space-y-2">
        <div class="flex items-center gap-3">
          <NuxtLink
            to="/"
            class="p-2 bg-white dark:bg-slate-900 rounded-xl border border-gray-100 dark:border-slate-800 shadow-sm text-gray-400 dark:text-slate-500 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors"
          >
            <svg
      ...
      <div
        v-if="store.isPulled"
        class="flex items-center gap-4 bg-white dark:bg-slate-900 p-2 pl-4 rounded-2xl border border-gray-100 dark:border-slate-800 shadow-sm transition-colors"
      >
    ...
    <div class="grid grid-cols-1 gap-8">
      ...
      >
        <div class="space-y-6">
          <div
            v-if="store.isPulled"
            class="p-4 bg-amber-50 dark:bg-amber-900/20 border border-amber-100 dark:border-amber-800/50 rounded-2xl flex items-start gap-3 text-amber-800 dark:text-amber-400"
          >
            <div
              class="bg-amber-100 dark:bg-amber-900/30 p-1.5 rounded-lg text-amber-600 dark:text-amber-500"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="18"
          ...
          >
            <div class="flex items-center gap-4">
              ...
              >
                <div
                  class="relative flex items-center justify-center w-6 h-6 border-2 border-gray-200 dark:border-slate-700 rounded-lg transition-all group-hover:border-indigo-500 group-hover:scale-105"
                  :class="{
                    'bg-indigo-600 border-indigo-600 shadow-lg shadow-indigo-200 dark:shadow-indigo-900/40':
                      pullUnpublishedOnly,
                  }"
                >
                  <svg
                ...
                <div class="flex flex-col">
                  <span
                    class="text-sm font-black text-gray-900 dark:text-white group-hover:text-indigo-600 dark:group-hover:text-indigo-400 transition-colors uppercase tracking-tight"
      ...
      >
        <div
          class="overflow-hidden rounded-2xl border border-gray-100 dark:border-slate-800 shadow-inner bg-gray-50/30 dark:bg-slate-950/20"
        >
        ...
        <div class="space-y-10">
          ...
          <div>
            <div class="flex items-center justify-between mb-6">
              <div class="space-y-1">
                <h4
                  class="text-sm font-black uppercase tracking-widest text-gray-400 dark:text-slate-500"
                >
                  Target Languages
                </h4>
                <p
              ...
              <div class="flex gap-4">
                <button
                  ...
                  class="text-[10px] font-black uppercase tracking-[0.2em] text-indigo-600 dark:text-indigo-400 hover:text-indigo-800 transition-colors"
                >
                  Select All
                </button>
                <button
          ...
          <div
            ...
            "
            class="space-y-6 pt-10 border-t border-gray-50 dark:border-slate-800"
          >
            <div
              v-if="isTranslating"
              class="space-y-4 bg-indigo-50/50 dark:bg-indigo-950/20 p-6 rounded-3xl border border-indigo-100/50 dark:border-indigo-900/30"
            >
              <div class="flex justify-between items-end">
                <div class="space-y-1">
                  ...
                  >
                  <p
                    class="text-sm font-black text-indigo-900 dark:text-indigo-300 uppercase tracking-tight"
                  >
          ...
          <div
            class="flex justify-end pt-8 border-t border-gray-50 dark:border-slate-800"
          >
            <button
      ...
      >
        ...
        >
          <div class="flex items-center gap-4">
            <div
              class="bg-gray-100 dark:bg-slate-800 p-3 rounded-2xl text-gray-400 dark:text-slate-500"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                ...
                >
                  ...
                  >
                    <td class="px-6 py-5 whitespace-nowrap">
                      <div class="flex items-center gap-3">
                        <div
                          class="w-8 h-8 rounded-lg bg-gray-100 dark:bg-slate-800 flex items-center justify-center text-[10px] font-black text-gray-500 dark:text-slate-400 uppercase"
                        >
                        ...
                        <div class="flex flex-col">
                          ...
                          >
                          <span
                            class="text-[10px] font-medium text-gray-500 dark:text-slate-500 uppercase tracking-tighter"
                            >{{ getLocaleName(locale as string) }}</span
                          >
                        </div>
                      </div>
                    </td>
                    <td class="px-6 py-5 whitespace-nowrap">
                      <span
                        ...
                        :class="
                          store.localeSource[locale as string] ===
                          'ai-generated'
                      ...
                      >
                        <template v-if="store.syncedLocales[locale as string]">
                          <div class="flex flex-col items-end">
                            ...
                            <span
                              class="text-[9px] font-medium text-gray-400 dark:text-slate-500"
                              >{{
                                formatTime(
                                  store.syncedLocales[locale as string]?.at,
                                )
                              }}</span
                            >
                          </div>
